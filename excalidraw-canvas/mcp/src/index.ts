  ...
  try {
    ...
    switch (name) {
      case 'create_element': {
        ...
        // For bound arrows without explicit points, derive from width/height
        if ((startElementId || endElementId) && !elementProps.points) {
          const pw = (element as any).width != null ? (element as any).width : 100;
          const ph = (element as any).height != null ? (element as any).height : 0;
          (element as any).points = [[0, 0], [pw, ph]];
        }
      ...
      case 'export_to_excalidraw_url': {
        ...
        for (const el of urlExportElements) {
          ...
          if (el.type === 'arrow' || el.type === 'line') {
            base.points = rest.points ?? [[0, 0], [base.width != null ? base.width : 100, base.height != null ? base.height : 0]];
          ...
          if (labelText) {
            ...
            if (isArrow) {
              ...
              const pts = base.points || [[0, 0], [base.width != null ? base.width : 100, base.height != null ? base.height : 0]];
